...
if(result EQUAL 0 OR NOT output MATCHES
   "schema_version.:4.*code.:.invalid_argument.*missing required option --webtransport-origin")
  message(FATAL_ERROR
...
execute_process(
  ...
  ERROR_VARIABLE diagnostics)
if(result EQUAL 0 OR NOT output MATCHES
   "schema_version.:4.*code.:.invalid_argument.*only valid for a trevrpc_webtransport server")
  message(FATAL_ERROR
...
execute_process(
  ...
  ERROR_VARIABLE diagnostics)
if(result EQUAL 0 OR NOT output MATCHES
   "schema_version.:4.*code.:.invalid_argument.*trevrpc_webtransport is server-only")
  message(FATAL_ERROR
