...
typedef struct trevrpc_rpc_transport trevrpc_transport;
typedef struct trevrpc_rpc_transport_event trevrpc_transport_event_v1;
typedef struct trevrpc_rpc_transport_receive trevrpc_transport_receive_v1;
