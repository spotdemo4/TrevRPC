if(NOT DEFINED TREVRPC_NM OR NOT DEFINED TREVRPC_ARCHIVES OR
   NOT DEFINED TREVRPC_PUBLIC_HEADERS OR NOT DEFINED TREVRPC_PUBLIC_MANIFEST OR
   NOT DEFINED TREVRPC_INTERNAL_MANIFEST OR NOT DEFINED TREVRPC_REMOVED_MANIFEST)
    message(FATAL_ERROR "symbol checker inputs are required")
endif()
if(NOT DEFINED TREVRPC_ABI_LABEL)
    set(TREVRPC_ABI_LABEL "ABI")
endif()
...
read_manifest("${TREVRPC_PUBLIC_MANIFEST}" public_manifest_symbols)
read_manifest("${TREVRPC_INTERNAL_MANIFEST}" internal_manifest_symbols)
read_manifest("${TREVRPC_REMOVED_MANIFEST}" removed_manifest_symbols)
...
endforeach()
set(undeclared_public_symbols "")
foreach(symbol IN LISTS public_symbols)
    if(NOT symbol IN_LIST header_symbols)
        list(APPEND undeclared_public_symbols "${symbol}")
    endif()
endforeach()
...
if(public_manifest_duplicates OR internal_manifest_duplicates OR removed_manifest_duplicates OR classification_overlap OR
   public_wrong_counts OR unclassified_header_symbols OR undeclared_public_symbols OR unclassified OR missing OR resurrected)
    ...
    list(JOIN undeclared_public_symbols ", " undeclared_public_symbols_text)
    list(JOIN unclassified ", " unclassified_text)
    list(JOIN missing ", " missing_text)
    list(JOIN resurrected ", " resurrected_text)
    message(FATAL_ERROR
        "${TREVRPC_ABI_LABEL} symbol classification failed\n"
        ...
        "public manifest functions absent from installed headers: ${undeclared_public_symbols_text}\n"
