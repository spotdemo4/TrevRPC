...
int trevrpc_msquic_native_listener_port(trevrpc_msquic_listener* listener, uint16_t* port);
...
int trevrpc_msquic_native_conn_open_stream(trevrpc_msquic_conn* conn, trevrpc_msquic_stream** stream);
int trevrpc_msquic_native_conn_open_uni_stream(trevrpc_msquic_conn* conn, trevrpc_msquic_stream** stream);
...
int trevrpc_msquic_native_stream_id(trevrpc_msquic_stream* stream, uint64_t* stream_id);
