...
static int composite_event_get_info(trevrpc_rpc_transport* transport,
    const trevrpc_rpc_transport_event* event_base,
    trevrpc_rpc_transport_event_info* info) {
    (void)transport;
...
static int composite_event_get_admission_info(trevrpc_rpc_transport* transport,
    const trevrpc_rpc_transport_event* event_base,
...
static int composite_event_get_protocol_info(trevrpc_rpc_transport* transport,
    const trevrpc_rpc_transport_event* event_base,
...
static int composite_admission_respond(
    trevrpc_rpc_transport* transport, const trevrpc_rpc_transport_event* event_base, uint16_t status) {
    (void)transport;
    const composite_event* event = (const composite_event*)event_base;
    if (event == NULL)
        return -EINVAL;
...
static void composite_event_release(trevrpc_rpc_transport* transport, trevrpc_rpc_transport_event* event_base) {
    (void)transport;
...
static int composite_receive_get_info(trevrpc_rpc_transport* transport,
    const trevrpc_rpc_transport_receive* receive_base,
...
static void composite_receive_release(trevrpc_rpc_transport* transport, trevrpc_rpc_transport_receive* receive_base) {
    (void)transport;
    composite_receive* receive = (composite_receive*)receive_base;
    composite_entry* entry;
    if (receive == NULL)
