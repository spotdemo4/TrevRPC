...
assert_not_contains "$help_file" 'TREVRPC_RUST_SPLIT_BENCH_QUINN_SEND_WINDOW_BYTES'
assert_not_contains "$help_file" 'TREVRPC_C_MSQUIC_PROFILE'
...
awk -F, '
    ...
    NR > 1 && (NF != 30 || $18 != "19" || $19 != "19" || $29 != "1234" || $30 != "234") {
...
assert_not_contains "$RUNNER" 'TREVRPC_JS_SEND_MANY_BATCH'
