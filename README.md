...
| Server         |                       C                       |                        C++                        |                       Go                        |                        Rust                         |                JavaScript (Node)                |                        Kotlin (netty)                         |                            Kotlin (android)                            |                          Chromium                           |                          Firefox                          |                         Safari                          |
| -------------- | :-------------------------------------------: | :-----------------------------------------------: | :---------------------------------------------: | :-------------------------------------------------: | :---------------------------------------------: | :-----------------------------------------------------------: | :--------------------------------------------------------------------: | :---------------------------------------------------------: | :-------------------------------------------------------: | :-----------------------------------------------------: |
| C              |         [![C→C][smoke-c-to-c]][smoke]         |         [![C++→C][smoke-cpp-to-c]][smoke]         |         [![Go→C][smoke-go-to-c]][smoke]         |         [![Rust→C][smoke-rust-to-c]][smoke]         |         [![JS→C][smoke-js-to-c]][smoke]         |         [![Kotlin netty→C][smoke-kotlin-to-c]][smoke]         |         [![Kotlin android→C][smoke-kotlin-cronet-to-c]][smoke]         |         [![Chromium→C][smoke-chromium-to-c]][smoke]         |         [![Firefox→C][smoke-firefox-to-c]][smoke]         |         [![Safari→C][smoke-webkit-to-c]][smoke]         |
| C++            |       [![C→C++][smoke-c-to-cpp]][smoke]       |       [![C++→C++][smoke-cpp-to-cpp]][smoke]       |       [![Go→C++][smoke-go-to-cpp]][smoke]       |       [![Rust→C++][smoke-rust-to-cpp]][smoke]       |       [![JS→C++][smoke-js-to-cpp]][smoke]       |       [![Kotlin netty→C++][smoke-kotlin-to-cpp]][smoke]       |       [![Kotlin android→C++][smoke-kotlin-cronet-to-cpp]][smoke]       |       [![Chromium→C++][smoke-chromium-to-cpp]][smoke]       |       [![Firefox→C++][smoke-firefox-to-cpp]][smoke]       |       [![Safari→C++][smoke-webkit-to-cpp]][smoke]       |
| Go             |        [![C→Go][smoke-c-to-go]][smoke]        |        [![C++→Go][smoke-cpp-to-go]][smoke]        |        [![Go→Go][smoke-go-to-go]][smoke]        |        [![Rust→Go][smoke-rust-to-go]][smoke]        |        [![JS→Go][smoke-js-to-go]][smoke]        |        [![Kotlin netty→Go][smoke-kotlin-to-go]][smoke]        |        [![Kotlin android→Go][smoke-kotlin-cronet-to-go]][smoke]        |        [![Chromium→Go][smoke-chromium-to-go]][smoke]        |        [![Firefox→Go][smoke-firefox-to-go]][smoke]        |                      Not supported                      |
| Rust           |      [![C→Rust][smoke-c-to-rust]][smoke]      |      [![C++→Rust][smoke-cpp-to-rust]][smoke]      |      [![Go→Rust][smoke-go-to-rust]][smoke]      |      [![Rust→Rust][smoke-rust-to-rust]][smoke]      |      [![JS→Rust][smoke-js-to-rust]][smoke]      |      [![Kotlin netty→Rust][smoke-kotlin-to-rust]][smoke]      |      [![Kotlin android→Rust][smoke-kotlin-cronet-to-rust]][smoke]      |      [![Chromium→Rust][smoke-chromium-to-rust]][smoke]      |      [![Firefox→Rust][smoke-firefox-to-rust]][smoke]      |                      Not supported                      |
| JavaScript     |        [![C→JS][smoke-c-to-js]][smoke]        |        [![C++→JS][smoke-cpp-to-js]][smoke]        |        [![Go→JS][smoke-go-to-js]][smoke]        |        [![Rust→JS][smoke-rust-to-js]][smoke]        |        [![JS→JS][smoke-js-to-js]][smoke]        |        [![Kotlin netty→JS][smoke-kotlin-to-js]][smoke]        |        [![Kotlin android→JS][smoke-kotlin-cronet-to-js]][smoke]        |        [![Chromium→JS][smoke-chromium-to-js]][smoke]        |        [![Firefox→JS][smoke-firefox-to-js]][smoke]        |        [![Safari→JS][smoke-webkit-to-js]][smoke]        |
| Kotlin (netty) | [![C→Kotlin netty][smoke-c-to-kotlin]][smoke] | [![C++→Kotlin netty][smoke-cpp-to-kotlin]][smoke] | [![Go→Kotlin netty][smoke-go-to-kotlin]][smoke] | [![Rust→Kotlin netty][smoke-rust-to-kotlin]][smoke] | [![JS→Kotlin netty][smoke-js-to-kotlin]][smoke] | [![Kotlin netty→Kotlin netty][smoke-kotlin-to-kotlin]][smoke] | [![Kotlin android→Kotlin netty][smoke-kotlin-cronet-to-kotlin]][smoke] | [![Chromium→Kotlin netty][smoke-chromium-to-kotlin]][smoke] | [![Firefox→Kotlin netty][smoke-firefox-to-kotlin]][smoke] | [![Safari→Kotlin netty][smoke-webkit-to-kotlin]][smoke] |

`Kotlin (android)` is the Cronet client transport; no Android server support is claimed.

Safari interoperability limitations:

- Go server: the bundled native transport currently supports cgo on Linux amd64 and arm64 only.
- Rust server: its draft-02 `h3` profile does not interoperate with Network.framework's legacy profile; see [h3#347](https://github.com/hyperium/h3/issues/347).
...
[smoke-kotlin-cronet-to-c]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-c&label=
[smoke-kotlin-cronet-to-cpp]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-cpp&label=
[smoke-kotlin-cronet-to-go]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-go&label=
[smoke-kotlin-cronet-to-rust]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-rust&label=
[smoke-kotlin-cronet-to-js]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-js&label=
[smoke-kotlin-cronet-to-kotlin]: https://img.shields.io/github/check-runs/spotdemo4/TrevRPC/main?nameFilter=smoke-kotlin-cronet-to-kotlin&label=
